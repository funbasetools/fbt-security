...
public class SignatureAlgorithmTest {
    ...
    private static final String EC224_PRIVATE_KEY = "ec224-private.pem";
    private static final String EC224_PUBLIC_KEY = "ec224-public.pem";
    private static final String EC256_PRIVATE_KEY = "ec256-private.pem";
    private static final String EC256_PUBLIC_KEY = "ec256-public.pem";
    private static final String EC384_PRIVATE_KEY = "ec384-private.pem";
    private static final String EC384_PUBLIC_KEY = "ec384-public.pem";
    private static final String EC512_PRIVATE_KEY = "ec512-private.pem";
    private static final String EC512_PUBLIC_KEY = "ec512-public.pem";
    private static final String RSA_PRIVATE_KEY = "rsa-private.pem";
    private static final String RSA_PUBLIC_KEY = "rsa-public.pem";
    ...
    public void testSha1WithRsaSignature() throws Exception {
        // given
        final RSAPublicKey pubKey = (RSAPublicKey) getPublicKey(PemKeyType.RSA, RSA_PUBLIC_KEY);
        final RSAPrivateKey prvKey = (RSAPrivateKey) getPrivateKey(PemKeyType.RSA, RSA_PRIVATE_KEY);

        final byte[] data = "Hello World!!".getBytes(StandardCharsets.UTF_8);

        final var keyProvider = SignatureAlgorithms.getRSAKeyProvider(prvKey, pubKey);
    ...
    public void testSha224WithEcdsaSignature() throws Exception {
        // given
        final ECPublicKey pubKey = (ECPublicKey) getPublicKey(PemKeyType.EC, EC224_PUBLIC_KEY);
        final ECPrivateKey prvKey = (ECPrivateKey) getPrivateKey(PemKeyType.EC, EC224_PRIVATE_KEY);

        final byte[] data = "Hello World!!".getBytes(StandardCharsets.UTF_8);

        final var keyProvider = SignatureAlgorithms.getECDSAKeyProvider(prvKey, pubKey);
    ...
    public void testSha256WithEcdsaSignature() throws Exception {
        // given
        final ECPublicKey pubKey = (ECPublicKey) getPublicKey(PemKeyType.EC, EC256_PUBLIC_KEY);
        final ECPrivateKey prvKey = (ECPrivateKey) getPrivateKey(PemKeyType.EC, EC256_PRIVATE_KEY);
    ...
    public void testSha384WithEcdsaSignature() throws Exception {
        // given
        final ECPublicKey pubKey = (ECPublicKey) getPublicKey(PemKeyType.EC, EC384_PUBLIC_KEY);
        final ECPrivateKey prvKey = (ECPrivateKey) getPrivateKey(PemKeyType.EC, EC384_PRIVATE_KEY);
    ...
    public void testSha512WithEcdsaSignature() throws Exception {
        // given
        final ECPublicKey pubKey = (ECPublicKey) getPublicKey(PemKeyType.EC, EC512_PUBLIC_KEY);
        final ECPrivateKey prvKey = (ECPrivateKey) getPrivateKey(PemKeyType.EC, EC512_PRIVATE_KEY);
    ...
    private PrivateKey getPrivateKey(final PemKeyType keyType, final String fileName) throws Exception {
        ...
        try (final FileInputStream fileInputStream = new FileInputStream(path)) {
            return PemUtils.getPrivateKey(keyType, fileInputStream);
        }
    }

    private PublicKey getPublicKey(final PemKeyType keyType, final String fileName) throws Exception {
        final String path = String.format("src/test/resources/%s", fileName);
        try (final FileInputStream fileInputStream = new FileInputStream(path)) {
            return PemUtils.getPublicKey(keyType, fileInputStream);
        }
    }
}
